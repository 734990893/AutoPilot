...
class World(object):
    ...
    def destroy_sensors(self):
        ...
        ## destroy custom sensors
        self.camera_manager.sensor_rgb.destroy()
        self.camera_manager.sensor_lidar.destroy()
        self.camera_manager.sensor_rgb = None
        self.camera_manager.sensor_lidar = None
...
class CameraManager(object):
    ...
    def _parse_image_control(weak_self, image, world):
        self = weak_self()
        if not self:
            return
            
        '''
        player = self._parent.get_world().player
        ...
        print(throttle, steer, brake, speed)
        '''
