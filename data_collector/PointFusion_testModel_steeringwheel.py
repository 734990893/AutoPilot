...
try:
    ...
    from pygame.locals import K_t   # custom key for NN tesing and manual steering
...
from pointFusion import PointFusion, feature_transform_regularizer
